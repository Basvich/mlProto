 ...
 * secuencial.
 * Con el uso posible de un iterator como coleccion, es posible pasarle literalmente una coleccion sin fin,
 * que funcionará correctamente. (bueno, salvo por el result que crece...)
 ...
 * @param endFunc
 */
export function simpleConcatSeries(coll: Array<any> | Iterator<any>, iteratee: ISimpleStep,
                                   endFunc: (error: any, data: Array<any>) => void) {
  let it: Iterator<any>;
  ...
  /** Devuelve un iterador de un array. Seguro que ya existe, pero mientras lo encuentro o no,
   * devuelvo este. (nota: array.values() no existe en chrome...)
   */
